...
public class RestTemplateUtil {
    ...
    private String addJobPath = "/job/add/";
    ...
    public String login(HttpMethod method) {
        Map<String, Object> defParam = new HashMap<>();
        defParam.put("username", this.userName);
        defParam.put("password", this.passWord);
        defParam.put("rememberMe", this.rememberMe);
        String result = execute(defParam, this.httpUrl + this.loginPath, method);
    ...
    public String addJob(JobAddReq jsonInfo) {
        login(HttpMethod.POST);
        HttpHeaders headers = this.getDefaultHeader();
        headers.set("Authorization",authorization);
        HttpEntity<JobAddReq> jobAddReqHttpEntity = new HttpEntity<>(jsonInfo, headers);
        ResponseEntity<String> response = restTemplate
                .exchange(httpUrl + addJobPath, HttpMethod.POST, jobAddReqHttpEntity, String.class);
        return response.getBody();
    }
