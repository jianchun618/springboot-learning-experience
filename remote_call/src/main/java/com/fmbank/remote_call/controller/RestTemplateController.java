...
import com.fmbank.remote_call.util.RestTemplateUtil;
...
public class RestTemplateController {
    ...
    public Object login(@RequestParam(value = "userName") String userName, @RequestParam(value = "passWord") String passWord) {
        log.info("loginParam-[{}]-[{}]",userName,passWord);
        return restTemplateUtil.login(HttpMethod.POST);
    }
    ...
    public String addJobInfo() {
        ...
        return restTemplateUtil.addJob(jobAddReq);
    }
}